...
export default function BrandDashboard({ products, sellers, orders, stripeConnected, stripeAccountId, stripeMainAccountId, onOpenStripeConnect, onDisconnectStripe }) {
  // 1. Calculations
